    ...
    <div className="container mx-auto px-4 py-8 sm:py-10 max-w-4xl space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
        <div className="relative backdrop-blur-sm border border-border bg-card/40 rounded-lg p-4">
          <CornerElements />
          <div className="flex items-center gap-2 text-primary font-mono text-xs font-semibold mb-1">
            <MailIcon className="size-4" />
            <span>DIRECT INQUIRY</span>
          </div>
          <p className="text-sm font-bold text-foreground">support@fitpilot.ai</p>
          <p className="text-xs text-muted-foreground mt-0.5">Direct technical inquiries</p>
        </div>
        ...
        <div className="relative backdrop-blur-sm border border-border bg-card/40 rounded-lg p-4">
          ...
          <p className="text-sm font-bold text-foreground">24 to 48 Hours</p>
          <p className="text-xs text-muted-foreground mt-0.5">Standard inquiry turnaround</p>
        </div>
        ...
        <div className="relative backdrop-blur-sm border border-border bg-card/40 rounded-lg p-4">
          ...
          <p className="text-sm font-bold text-foreground truncate">github.com/amandubey923</p>
          <p className="text-xs text-muted-foreground mt-0.5">Issues & feature feedback</p>
        </div>
      </div>
      ...
      <div className="relative backdrop-blur-sm border border-border bg-card/50 rounded-xl p-5 sm:p-7">
        ...
        <div className="flex items-center justify-between mb-4 pb-2 border-b border-border/70">
          <h2 className="text-base sm:text-lg font-bold font-mono text-foreground flex items-center gap-2">
            <MessageSquare className="size-4 text-primary" />
            <span>DISPATCH INQUIRY FORM</span>
          </h2>
          <span className="text-xs font-mono text-muted-foreground">ENCRYPTED // DIRECT</span>
        </div>
        ...
        {isSubmitted ? (
          <div className="p-6 text-center space-y-3 animate-in fade-in duration-200">
            ...
            <div className="pt-2">
              <Button
                ...
                variant="outline"
                onClick={handleReset}
                className="h-8 px-4 text-xs sm:text-sm font-mono border-primary/40 text-primary hover:bg-primary/10"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div className="flex items-center gap-2 p-2.5 rounded bg-destructive/10 border border-destructive/30 text-destructive text-xs sm:text-sm font-mono">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full h-9 bg-background/50 border border-border rounded px-3 text-xs sm:text-sm text-foreground focus:outline-none focus:border-primary placeholder:text-muted-foreground transition-colors"
                />
              </div>
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                disabled={isSubmitting}
                className="w-full h-9 bg-background/50 border border-border rounded px-3 text-xs sm:text-sm text-foreground focus:outline-none focus:border-primary transition-colors"
              >
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                disabled={isSubmitting}
                className="w-full bg-background/50 border border-border rounded p-3 text-xs sm:text-sm text-foreground focus:outline-none focus:border-primary placeholder:text-muted-foreground resize-none transition-colors"
              />
            </div>
